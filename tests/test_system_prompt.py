...
class SystemPromptTests(unittest.TestCase):
    def test_prompt_keeps_generic_tool_and_scanning_rules(self) -> None:
        self.assertIn("Device: run_package, uiautomate, screenshot, tap, swipe_up, swipe_down, swipe_back", SYSTEM_PROMPT)
    ...
    def test_prompt_keeps_generic_range_and_output_requirements(self) -> None:
        ...
        self.assertIn("Excel rows must be grouped by merchant", SYSTEM_PROMPT)
    ...
    def test_prompt_requires_complete_merchant_collection_before_exit(self) -> None:
        ...
        self.assertIn("Write that merchant to Excel before returning to the list", SYSTEM_PROMPT)
