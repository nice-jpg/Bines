...
- After address selection succeeds, continue to the merchant list, then read XML, identify visible merchants, distance text, title/icon tap targets, and whether each merchant was already handled.
